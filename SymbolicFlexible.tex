...
$[\v{\tilde{{\omega}}}_i] = \v{\dot{R}}_i\v{R}_i^T$, where $[\tilde{\ \ }]$ represents the skew symmetric matrix, and $^T$ denote the matrix transpose. 
...
To simplify the equations and limit their length when printing them in this article, we have applied a first-order small-angle approximation for $\theta_t$, and a second-order approximatio for $\nu_x$ and $\nu_y$.
