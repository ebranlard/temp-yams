...
The geometrically exact beam theory \citep{Simo:1985,Jelenic:1999,Geradin:2001:book,Bauchau:2011:book} is more precise than the shape function approach in that it represents the beam kinematics exactly.
...
These more advanced approaches target different applications than those envisioned in this study: they are suitable for numerical simulations, but they cannot provide compact symbolic model equations.
...
Since, in this example, the beam is fixed except for a rotational degree of freedom, and no gravitity is assumed, all other stiffening influence can be neglected.
