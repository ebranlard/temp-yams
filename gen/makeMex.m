...
if exist(code_file, 'file')
    ...
    filesize = ftell(fid);
    fclose(fid);
    if filesize>0 && dd_src.datenum<dd_dst.datenum
        skip_gen= true;
    end
end
if ~skip_gen
...
options= {'-g' output_str mex_name  '-v'};
if is_matlab
